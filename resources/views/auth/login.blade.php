...
<body class="antialiased min-h-screen flex items-center justify-center p-4 relative"
    ...
    <div
        ...
        <form id="loginForm" action="{{ route('login.post') }}" method="POST" class="space-y-6" novalidate>
            ...
            <button type="submit"
                class="w-full flex items-center justify-center gap-2 py-3.5 px-4 bg-navy hover:bg-gold text-white font-poppins font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                <span>Login</span>
