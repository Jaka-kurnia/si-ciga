    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                ...
                <div
                    class="bg-navy border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm hover:border-gold/30 transition-colors group">
