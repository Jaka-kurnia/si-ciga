<section id="beranda" class="relative bg-navy text-white h-[80vh] flex items-center justify-center overflow-hidden">
  ...
  <div id="hero-slider" class="absolute inset-0 w-full h-full">
    <div class="hero-slide absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-40" style="background-image: url('/img/hero1.jpeg')"></div>
    <div class="hero-slide absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-0" style="background-image: url('/img/hero2.jpeg')"></div>
    <div class="hero-slide absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-0" style="background-image: url('/img/hero3.jpeg')"></div>
    <div class="hero-slide absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-0" style="background-image: url('/img/hero4.jpeg')"></div>
  </div>
  
  <!-- Content overlay -->
  <div class="relative z-10 text-center px-4 max-w-4xl" data-aos="fade-up" data-aos-duration="1200">
    <h1 class="text-4xl md:text-6xl font-poppins font-bold mb-6 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] leading-tight">
