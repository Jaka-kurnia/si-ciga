<section id="visimisi" class="py-20 bg-white overflow-hidden">
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row gap-8">
    <div class="flex-1 bg-navy text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group" data-aos="fade-right">
    ...
    <div class="flex-1 bg-white border border-gray-200 text-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:border-gold/50 transition-all duration-300 transform hover:-translate-y-2 group" data-aos="fade-left">
      <div class="w-16 h-16 bg-navy/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
