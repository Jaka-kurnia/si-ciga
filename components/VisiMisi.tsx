  ...
  return (
    <section id="visimisi" className="py-20 bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row gap-8">
        {/* Card Visi */}
        <div className="flex-1 bg-navy text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
        ...
        {/* Card Misi */}
        <div className="flex-1 bg-white border border-gray-200 text-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:border-gold/50 transition-all duration-300 transform hover:-translate-y-2 group">
